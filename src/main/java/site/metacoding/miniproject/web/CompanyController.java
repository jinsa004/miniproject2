...
public class CompanyController {
    ...
    // companyService.login(companyLoginReqDto);
    ...
    // public @ResponseBody ResponseDto<?> 기업정보관리(@PathVariable Integer companyId,
    // Model model) {
    ...
    // public String 기업소개상세(@PathVariable Integer companyId, Model model) {// 기업소개
    // 상세보기 intro 테이블
    // session.getAttribute("coprincipal");
