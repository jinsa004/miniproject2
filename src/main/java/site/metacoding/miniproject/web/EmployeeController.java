...
public class EmployeeController {
    ...
    // @PathVariable Integer subscribeId) {// 구독취소
    ...
    // public String 회원정보수정탈퇴페이지(@PathVariable Integer employeeId, Model model) {//
    // 개인회원 회원가입 정보수정
    // // 리스트값 불러오기
    ...
    // public @ResponseBody ResponseDto<?> 회원탈퇴(@PathVariable Integer employeeId,
    // HttpServletResponse response) {
    ...
    // public @ResponseBody ResponseDto<?> 회원가입(@RequestBody EmpJoinReqDto
    // employeeJoinDto) {
